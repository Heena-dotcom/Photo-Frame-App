...
package crephotoseditor.valentinephotoeditor.clr;
...
import crephotoseditor.valentinephotoeditor.clr.ColorPickerView.OnColorChangedListener;
            ...
            colorPanelView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    for (int i = 0; i < shadesLayout.getChildCount(); i++) {
                        ...
                        ImageView iv = (ImageView) layout.findViewById(R.id.cpv_color_image_view);
                        iv.setImageResource(cpv == v ? R.drawable.ic_done : 0);
